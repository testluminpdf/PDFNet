...
TRN_API TRN_DownloaderCreate(struct TRN_DownloadCallbacks* callbacks, size_t file_size, TRN_UString cache_file, TRN_Bool minimal_downloads, TRN_Downloader* result);
...
TRN_API TRN_PDFDocMergeXFDF(TRN_PDFDoc doc, TRN_Filter stream, const TRN_OptionBase* options);
TRN_API TRN_PDFDocMergeXFDFString(TRN_PDFDoc doc, const TRN_UString xfdf, const TRN_OptionBase* options);
